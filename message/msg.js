     ...
     client.DeleteMessage(ah, botNumber)
      ...
      case prefix+'m': case prefix+'menu':{//Rfz XM
           client.sendMessage(from, { react: { text: "📍️", key: msg.key }})
             ...
             let sourceUrl =  'ʜᴛᴛᴘs://ɴᴇᴋᴏᴘᴏɪ.ᴄᴀʀᴇ'
             let mediaUrl = 'ʜᴛᴛᴘs://ɴᴇᴋᴏᴘᴏɪ.ᴄᴀʀᴇ'                            
...
//
  ...
  const listMessage = {
     text: "MP3/M4A", footer: SETTING.botname, title: "ᴛɪᴘᴇ ᴀᴜᴅɪᴏ ʏᴀɴɢ ᴍᴀᴜ ᴅɪᴋɪʀɪᴍ", buttonText: "ᴋʟɪᴋ", sections
    }
    client.sendMessage(from, listMessage, {quoted:msg})
   }
  break
      ...
      let aud = {
          ...
          contextInfo:{
           externalAdReply:{
             ...
             thumbnail: thumb,
             sourceUrl: "ʜᴛᴛᴘs://ɴᴇᴋᴏᴘᴏɪ.ᴄᴀʀᴇ",
             mediaUrl: "ʜᴛᴛᴘs://ɴᴇᴋᴏᴘᴏɪ.ᴄᴀʀᴇ",
